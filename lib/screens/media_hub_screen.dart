      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Row(
                    children: [
                      Icon(Icons.insights_rounded, color: Color(0xFF00D9FF), size: 24),
                      SizedBox(width: 8),
                      Text(
                        'Your Reach',
                        style: TextStyle(
            ...
            const Row(
              children: [
                Icon(Icons.music_note_rounded, color: Color(0xFF00D9FF), size: 20),
                SizedBox(width: 8),
                Text(
                  'Streaming Platforms',
                  style: TextStyle(
            ...
            const Row(
              children: [
                Icon(Icons.public_rounded, color: Color(0xFF00D9FF), size: 20),
                SizedBox(width: 8),
                Text(
                  'Social Media',
                  style: TextStyle(
